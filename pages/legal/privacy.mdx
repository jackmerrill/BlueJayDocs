...
Governments or law enforcement may request data from OVH, Stripe, Vercel, Discord, Roblox, Uberspace, rh-tec, uvensys, or Matt Ronchetto (doamatto) at any time, which we have no control over. OVH can access database data at any time, as they have the encryption keys for our databases. Matt Ronchetto (doamatto) can access analytical data at anytime, as they are the maintainer of and possess the encryption keys for the Uberspace instance. Government or law enforcement requests to any of our subprocessors are out of control, with those entities having their own policies of when to forfeit data over.

**TODO: Handling government requests needed**
...
- Uberspace, rh-tec Business GmbH, uvensys GmbH, and their subprocessors: They host the Umami instance.
...
- OVH [and their suprocessors](https://us.ovhcloud.com/legal/data-processing-agreement) in Beauharnois, Canada,
