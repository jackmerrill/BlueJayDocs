...
We do not knowingly collect data on users under the age of 13. In the event that we are made aware of someone under this age requirement registers for our service, we take appropriate means to delete that data permanently. We use Lunar Design's [Agecheck](https://github.com/designbylunar/agecheck) to comply with countries that have this requirement set higher. You can see how old you need to be to register for BlueJay [here.](https://github.com/designbylunar/agecheck/blob/main/lib/countries.dart)

## Where can I find past versions of this policy?
We keep past versions of our policy [here.](https://github.com/jackmerrill/BlueJayDocs/blob/main/pages/legal/privacy.mdx) When changes are made to this policy, we will notify all users via our web app.
