...
You can manage or delete your data at any time [via the account panel.](https://bluejay.one/settings) You cannot delete, nor request deletion, of data from Umami, as there is no way to identify users.
