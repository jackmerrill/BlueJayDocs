...
We do not share, sell, or transfer any data collected with any third parties. Data is stored on Uberspace in Germany and uses Uberspace's keys.

## Who has access to this data?
Governments or law enforcement may request data from Uberspace, Stripe, Vercel, Discord, Roblox, rh-tec, uvensys, or Matt Ronchetto (doamatto) at any time, which we have no control over. Uberspace can access database data at any time, as they have the encryption keys for our databases. Matt Ronchetto (doamatto) can access analytical data at anytime, as they are the maintainer of and possess the encryption keys for the Uberspace instance. Government or law enforcement requests to any of our subprocessors are out of control, with those entities having their own policies of when to forfeit data over.
...
- Uberspace, rh-tec Business GmbH, uvensys GmbH, and their subprocessors: They host our databases, Discord bots, and main website, as well as the Umami instance.
